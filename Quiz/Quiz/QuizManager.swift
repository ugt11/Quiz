...
class QuizManager {
    ...
    init() {
        quizzes = []
        quizzes.append(Quiz(text: "ネコは人間を超でっかいネコだと思っている？", correctAnswer: true, imageName: "cat"))
        ...
        quizzes.append(Quiz(text: "クマは走る時に全部の足がバラバラに動いている？", correctAnswer: false, imageName: "bear"))
